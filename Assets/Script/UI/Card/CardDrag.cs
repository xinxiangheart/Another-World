...
public class CardDrag : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        // Network guard: block drag if not local player or not your turn
        if (NetworkClient.isConnected && NetworkPlayer.Local != null && (!NetworkPlayer.Local.isLocalPlayer || FindObjectOfType<TurnManager>()?.currentPhase != TurnManager.TurnPhase.MyTurn))
        {
            return;
        }
