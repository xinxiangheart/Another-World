...
2026-09-12 批次（01110 碎片、01111 深潜者、01113 传送阵、01114 暴徒、01118 猎犬、01119 认同指令、01125 投机者、01126 凝聚体、01127 改造者、01128 超数故障、01129 滋养者、01136 难民、01302 疗、01303 潜行者、01308 麻烦制造者、01322 残篇、01328 破防者、01523 水墨、01524 画卷之核）同样按此基准出图，2026-09-13 续出 01332 异面信徒（全库唯一双前缀卡）、01333 幻身、01334 集群意识、01335 能量骇客、01336 修正者；逐张的形象、取舍与抠图参数记在 `Assets/_Game/Art/Old/README.md` 的「替换记录」表。
...
> **5 费（传奇）档另放开姿势 / 视角 / 构图**（见「5 费（传奇）档」）——那是**画面调度**的放开，**本表不因此改变**：唯一点缀色色相与母题一律照旧。
...
已有卡图 9 张——按基准规格（1152x1536）的 8 张：01102 堕落者（跪姿紫袍 + 触手）、01103 腐化之心（基准卡，心口紫光）、01115 虚伪之火（紫焰空壳 + 虚空独眼）、01116 肉山（锥形肉山 + 群眼 / 紫涡底盘）、01117 苦难给予者（旋涡中伸出）、01302 疗（跪坐按地 / 掌侧紫雾）、01303 潜行者（低伏四足蹲踞 / 前肢散成触手束，点缀色在触手尖端与眉心裂缝）、01332 异面信徒（双前缀，机械主体 + 渊母题，见「双前缀」）；另有 01317 贪欲之蛇仍是旧规格（1800x2400），要重绘时一并列上。
