...
| 3 费 | **17 / 21**（1152x1536） | 0.86 × 0.87，填充 0.30 | 余下 01348（1800×2400）、01327 / 01338 / 01343（2000×2666）仍是旧规格 |
| 5 费 | **1**（01523 水墨） | 0.48 × 0.91 | 01514 勇者仍是旧规格（2000×2666） |

> **5 费那行的占幅带仍是提案，3 费已转为实测。** 3 费现有 17 张（中位 0.86 × 0.87），提案带基本成立；但同档里 01306 阴（0.65）、01307 阳（0.67）、01334 集群意识（0.63）明显偏窄——**小巧器物、多体同框同样成立**，要守的始终是「体量 / 压迫感」，不是数字本身。5 费样本仍只有 01523 一张，且只有 0.48 宽（竖长的场域物），5 费不等于占满宽。
...
已有卡图 9 张——按基准规格（1152x1536）的 8 张：01102 堕落者（跪姿紫袍 + 触手）、01103 腐化之心（基准卡，心口紫光）、01115 虚伪之火（紫焰空壳 + 虚空独眼）、01116 肉山（锥形肉山 + 群眼 / 紫涡底盘）、01117 苦难给予者（旋涡中伸出）、01302 疗（跪坐按地 / 掌侧紫雾）、01303 潜行者（低伏四足蹲踞 / 前肢散成触手束，点缀色在触手尖端与眉心裂缝）、01332 异面信徒（双前缀，机械主体 + 渊母题，见「双前缀」）、01317 贪欲之蛇（盘成三圈的巨蛇 / 盘心独眼 / 身下旋涡，2026-09-13，由 1800x2400 的恶搞占位稿改为正式插画）。

暂无卡图 6 张：3002 幽魂、1304 黑暗骑士、1331 囚牢、1503 领主、1526 忤逆者、3003 被腐化者。
